...
const SinglePlayerNotetaking = ({ curPinIndex, setCurPinIndex, prevPinIndex, setPrevPinIndex }) => {
    //session values
    ...
    useEffect(() => {
        ...
        if (singlePlayerPins[curPinIndex] && userMode === "caller") {
            setPinType(singlePlayerPins[curPinIndex].callerPinCategory);
            setCurNoteInfo(singlePlayerPins[curPinIndex].callerPinNote);
            setCurPerspectiveInfo(singlePlayerPins[curPinIndex].callerPinPerspective);
            setCurSkillInfo(singlePlayerPins[curPinIndex].callerPinSkill);
        } else if(singlePlayerPins[curPinIndex]){
            ...
            <ColorLibPaper elevation={1}>
                ...
                {curPinIndex !== -1 ?
                    <Box fontStyle="italic">
                        <Typography>
                            The session was pinned at {formatTime(singlePlayerPins.map(pin => pin.pinTime)[curPinIndex])}
                        </Typography>
                    </Box>
                    : null}
                <ColorLibTextField
